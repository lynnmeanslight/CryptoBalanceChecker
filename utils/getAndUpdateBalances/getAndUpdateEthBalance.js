...
async function getAndUpdateBalancesOfEthFromEth(
  evm_addresses,
  sheets,
  spreadsheetId
) {
  try {
    ...
    while (startIndex < len) {
      ...
      const url = `https://api.etherscan.io/api?module=account&action=balancemulti&address=${slicedArr.join(
        ","
...
module.exports = { getAndUpdateBalancesOfEthFromEth };
